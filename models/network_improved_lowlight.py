...
class Network(BaseNetwork):
    def __init__(self, unet, beta_schedule, module_name='sr3', **kwargs):
        ...
        elif module_name == 'lowlight':
            from .guided_diffusion_modules.unet_modified_full_lowlight import UNet
    ...
    def forward(self, y_0, y_cond=None, noise=None): #参数顺序，真实图片y_0，合成图片(条件图片y_cond)以及mask
